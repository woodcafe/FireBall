...
#define cpu_map_h
  ...
  #define STEP_BIT_1 3  // Z Step - Pin A6
  #define STEP_BIT_2 6  // Y Step - Pin D46
...
//  #define DIRECTION_PORT_2 L
  ...
  #define DIRECTION_BIT_1 1 // Z Dir - Pin A7
  #define DIRECTION_BIT_2 7 // Y Dir - Pin D48
...
//  #define STEPPER_DISABLE_PORT_2 K
  ...
  #define STEPPER_DISABLE_BIT_1 0 // Z Enable - Pin A2
  #define STEPPER_DISABLE_BIT_2 2 // Y Enable - Pin A8
...
//  #define SPINDLE_ENABLE_BIT      5 // MEGA2560 Digital Pin 4 - Ramps 1.4 Servo 4 Signal pin
  #define SPINDLE_ENABLE_DDR      DDRH
  #define SPINDLE_ENABLE_PORT     PORTH
  #define SPINDLE_ENABLE_BIT      6 // MEGA2560 Digital Pin 4 - Ramps 1.4 Servo 4 Signal pin
  #define SPINDLE_DIRECTION_DDR   DDRE
  #define SPINDLE_DIRECTION_PORT  PORTE
