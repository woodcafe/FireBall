...
void RepStepper::setDirection(bool direction)
{
  ...
  delayMicroseconds(50); //make sure it stabilizes..
...
void RepStepper::pulse()
{
  ...
  delayMicroseconds(5); //make sure it stabilizes... for opto isolated stepper drivers. //5
  digitalWrite(this->step_pin, LOW);
}

void RepStepper :: step(int speed ) {
  digitalWrite(this->step_pin, HIGH);
  delayMicroseconds(speed); //make sure it stabilizes... for opto isolated stepper drivers. //5
  digitalWrite(this->step_pin, LOW);
}
